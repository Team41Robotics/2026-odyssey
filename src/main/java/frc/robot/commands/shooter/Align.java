...
public class Align extends Command {
	public static final double AIM_kP = 7.0;
	...
	public void execute() {
		...
		Logger.recordOutput("/Align/targetAngleRad", targetAngle);
		Logger.recordOutput("/Align/headingErrorRad", headingController.getError());
	}
}
